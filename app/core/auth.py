...
def get_public_api_key() -> str:
    """兼容旧 public 命名，复用 function_key。"""
    return get_function_api_key()
...
def is_public_enabled() -> bool:
    """兼容旧 public 命名，复用 function_enabled。"""
...
async def verify_public_key(
    ...
    """兼容旧 public API 认证入口，复用 function 逻辑。"""
    return await verify_function_key(auth)
